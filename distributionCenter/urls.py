...
urlpatterns = [
    ...
    path('product/sell/', views.ProductSellAPIView.as_view(), name='product_sell'),
    path('product/request/<slug:product>/<int:quantity>/', views.HubTradeResponseAPIView.as_view(), name='request_from_hub')
]